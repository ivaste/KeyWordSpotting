...
\subsection{Ensemble}
The ensemble simply took the two best models and did the average of their final prediction, in this way we reached the best accuracy paying a high price: a large network.
...
\multicolumn{1}{l}{}   & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + deltas MFCC} & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + deltas MFCC} \\ \midrule
\textbf{Accuracy \%}   & 96.0               & 95.3             & 93.9                     & 93.4             & boh              & boh                      \\ \midrule
\textbf{\# parameters} & 874,930           & 571,330           & 1,178,530                  & 1,375,881          & boh              & boh                      \\ \midrule
\textbf{\begin{tabular}[c]{@{}c@{}}Speed (ms)\\ Speed with FE\end{tabular}} &
  \begin{tabular}[c]{@{}l@{}}33.39\\ 41.44\end{tabular} &
...
\textbf{Accuracy \%}   & 94.3             & 95.0               & 94.8                     & 92.7             & 92.2             & boh                      \\ \midrule
\textbf{\# parameters} & 469,398           & 262,998           & 675,798                   & 832,673           & 399,233           & boh                      \\ \midrule
\textbf{\begin{tabular}[c]{@{}c@{}}Speed (ms)\\ Speed with FE\end{tabular}} &
  \begin{tabular}[c]{@{}l@{}}30.75\\ 38.49\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}29.55\\ 38.23\end{tabular} &
  boh &
  \begin{tabular}[c]{@{}l@{}}32.25\\ 39.72\end{tabular} &
...
\multicolumn{1}{l}{\multirow{2}{*}{}} &
  ...
  \multicolumn{3}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}21 commands\\ (84K-9K-11K)\end{tabular}}} \\ \cmidrule(l){2-7} 
\multicolumn{1}{l}{}   & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + $\Delta$ MFCC} & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + $\Delta$ MFCC} \\ \midrule
\textbf{Accuracy \%}   & 92.5             & 92.9             & boh                      & 90.0               & 89.2             & boh                      \\ \midrule
\textbf{\# parameters} & 300,618           & 127,818           & boh                      & 604,757           & 241,877           & boh                      \\ \midrule
\textbf{\begin{tabular}[c]{@{}c@{}}Speed (ms)\\ Speed with FE\end{tabular}} &
  \begin{tabular}[c]{@{}l@{}}31.00\\ 38.31\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}29.27\\ 38.23\end{tabular} &
  boh &
  \begin{tabular}[c]{@{}l@{}}32.86\\ 37.97\end{tabular} &
...
\multicolumn{1}{l}{\multirow{2}{*}{}} &
  ...
  \multicolumn{3}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}21 commands\\ (84K-9K-11K)\end{tabular}}} \\ \cmidrule(l){2-7} 
\multicolumn{1}{l}{} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv Large 80 Mels\\ +\\ DSConv Large 40 MFCC\end{tabular}}} &
  \multicolumn{1}{c}{\textit{boh}} &
  \multicolumn{1}{c}{\textit{boh}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv Large 80 Mels\\ +\\ DSConv Large 40 MFCC\end{tabular}}} &
  \multicolumn{1}{c}{\textit{boh}} &
  \multicolumn{1}{c}{\textit{boh}} \\ \midrule
\textbf{Accuracy \%}   & 96.6    & 92.9   & boh & 90.0     & 89.2   & boh \\ \midrule
\textbf{\# parameters} & 1,446,260 & 127,818 & boh & 604,757 & 241,877 & boh \\ \midrule
\textbf{Speed (ms}     & 89.28   & boh    & boh & boh    & boh    & boh \\ \bottomrule
\end{tabular}}
