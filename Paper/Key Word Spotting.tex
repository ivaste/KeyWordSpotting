...
\justifying{In our work we adopted a Depthwise Separable CNN inspired by [3]. This CNN is made of a 2D CNNs followed by batch normalization and four or five DSConv2D layers. An average pooling, with padding 2$\times$2 and stride 2$\times$2, followed by a fully-connected layer, is used in the end to provide global interaction and reduce the total number of parameters in the final layer.
...
\subsection{Ensemble}
We built three kinds of ensembles: \textit{large}, \textit{medium} and \textit{small}, in order to have models that can fit different hardware sizes.  The ensembles simply pick the two best models and compute the average of their final prediction, in this way we reached the best accuracy paying a high price: larger networks.

All models are trained with the \textbf{Google Tensorflow 2.1} Framework with \textbf{Keras} using the standard \textit{Sparse categorical cross entropy} and \textit{Nadam optimizer}. With a batch size of 32, the models were trained for 100 epochs with initial learning rate of $10^{-4}$. An early stopping with a patience of 10 epochs was applied to avoid overfitting.
...
%We should not consider \textit{multiplication} as metric because it is an indirect alternative for a direct metric such as \textit{latency}.
...
\multicolumn{1}{l}{\multirow{2}{*}{}} &
  ...
  \multicolumn{3}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}21-commands\\ (84K-9K-11K)\end{tabular}}} \\ \cmidrule(l){2-7} 
\multicolumn{1}{l}{} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv L 80 Mels\\ +\\ DSConv L 40 MFCC\\ +\\ DSConv L 40 MFCC $\Delta$\end{tabular}}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv L 40 MFCC\\ +\\ DSConv M 80 Mels\\ +\\ DSConv M 40 MFCC\end{tabular}}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv M 40 MFCC\\ +\\ DSConv M 80 Mels\\ +\\ DSConv S 40 MFCC\end{tabular}}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv L 80 Mels\\ +\\ DSConv L 40 MFCC\\ +\\ DSConv L 40 MFCC $\Delta$\end{tabular}}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv L 40 MFCC\\ +\\ DSConv M 80 Mels\\ +\\ DSConv L 40 MFCC\end{tabular}}} &
  \multicolumn{1}{c}{\textit{\begin{tabular}[c]{@{}c@{}}DSConv L 40 MFCC\\ +\\ DSConv M 80 Mels\\ +\\ DSConv L 40 MFCC\end{tabular}}} \\ \midrule
...
\begin{tabular}{llll}
\cline{2-4}
                           & \textbf{Assemble \%} & \textbf{\# Parameters} & \textbf{Speed (ms)} \\ \hline
SincConv                   & 97.4                 & 162,000                & 40.35               \\ \hline
Our Ensemble Large         & \textbf{96.8}        & 2,624,790              & 131.01              \\ \hline
Our Ensemble Medium        & 96.4                 & 1,303,726              & 122.04              \\ \hline
Our DSConvLarge + 80Mels  & 96.0                 & 874,930                & 41.44               \\ \hline
Our Ensemble Small         & 95.6                 & 691,463                & 106.09              \\ \hline
Our DSConvMedium + 40MFCC & 95.0                 & 262,998                & 38.23               \\ \hline
1DCNN on raw data         & 93.0                 & 257,018                & \textbf{28.71}      \\ \hline
Our DSConvSmall + 40MFCC   & 92.9                 & \textbf{127,818}       & 38.23               \\ \hline
\end{tabular}}
\caption{10-commands}
\end{table*}
...
\begin{tabular}{llll}
\cline{2-4}
                          & Accuracy \%   & \# parameters    & Speed (ms)     \\ \hline
SincConv                  & 97.4          & 162,000          & 40.35          \\ \hline
...
Our Ensemble + 40MFCC     & 93.7          & 738,321          & 39.66          \\ \hline
Our DSConvMedium + 80Mels & 92.7          & 832,673          & 39.72          \\ \hline
Our DSConvSmall + 80Mels  & 90.0          & 604,757          & 37.97          \\ \hline
1DCNN on raw data         & 89.1          & \textbf{257,733} & \textbf{28.25} \\ \hline
\end{tabular}}\\
\caption{21-commands}
\end{table*}
