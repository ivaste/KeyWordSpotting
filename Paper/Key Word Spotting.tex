...
\textbf{Small} &
  ...
  \begin{tabular}[c]{@{}l@{}}64\\ 10x4\\ 2x2\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}64\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}64\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}64\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}64\\ 3x3\\ 1x1\end{tabular} &
  NA \\ \midrule
\textbf{Medium} &
  \begin{tabular}[c]{@{}l@{}}\#Filters\\ Filter size\\ Stride\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}172\\ 10x4\\ 1x2\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}172\\ 3x3\\ 2x2\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}172\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}172\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}172\\ 3x3\\ 1x1\end{tabular} &
  NA \\ \midrule
\textbf{Large} &
  \begin{tabular}[c]{@{}l@{}}\# Filters\\ Filter size\\ Stride\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 10x4\\ 1x2\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 3x3\\ 2x2\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 3x3\\ 1x1\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}276\\ 3x3\\ 1x1\end{tabular} \\ \bottomrule
\end{tabular}}
\caption{DESCRIZIONE}
\end{table*}
\end{center}

This model uses Depthwise Separable Convolutions. A separable convolution uses less parameters, less memory and less computations than regular convolutional layers, and in general it even perform better.
...
\textbf{\# parameters} & 257018 & 257733 \\ \midrule
...
\textbf{Accuracy \%}   & 96               & 95,3             & 93,9                     & 93,4             & boh              & boh                      \\ \midrule
\textbf{\# parameters} & 874930           & 571330           & 1178530                  & 1375881          & boh              & boh                      \\ \midrule
...
\textbf{Accuracy \%}   & 94,3             & 95               & 94,8                     & 92,7             & 92,2             & boh                      \\ \midrule
\textbf{\# parameters} & 469398           & 262998           & 675798                   & 832673           & 399233           & boh                      \\ \midrule
\textbf{\begin{tabular}[c]{@{}c@{}}Speed (ms)\\ Speed with FE\end{tabular}} &
...
\multicolumn{1}{l}{\multirow{2}{*}{}} &
  ...
  \multicolumn{3}{c}{\textbf{\begin{tabular}[c]{@{}c@{}}21 commands\\ (84K-9K-11K)\end{tabular}}} \\ \cmidrule(l){2-7} 
\multicolumn{1}{l}{}   & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + $\Delta$ MFCC} & \textit{80 Mels} & \textit{40 MFCC} & \textit{40 + $\Delta$ MFCC} \\ \midrule
\textbf{Accuracy \%}   & 92,5             & 92,9             & boh                      & 90               & 89,2             & boh                      \\ \midrule
\textbf{\# parameters} & 300618           & 127818           & boh                      & 604757           & 241877           & boh                      \\ \midrule
\textbf{\begin{tabular}[c]{@{}c@{}}Speed (ms)\\ Speed with FE\end{tabular}} &
...
\textbf{Accuracy \%}   & 96,6    & 92,9   & boh & 90     & 89,2   & boh \\ \midrule
\textbf{\# parameters} & 1446260 & 127818 & boh & 604757 & 241877 & boh \\ \midrule
